...
default['pgpool']['pgconf']['enable_pool_hba'] = true # Might want to override
...
default['pgpool']['pgconf']['backend_flag0'] = 'DISALLOW_TO_FAILOVER'
default['pgpool']['pgconf']['backend_flag1'] = 'DISALLOW_TO_FAILOVER'
...
default['pgpool']['pgconf']['log_connections'] = true # Should override
default['pgpool']['pgconf']['log_hostname'] = true # Should override possibly
default['pgpool']['pgconf']['log_statement'] = true
default['pgpool']['pgconf']['log_per_node_statement'] = true
